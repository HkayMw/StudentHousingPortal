...
CREATE TABLE IF NOT EXISTS shp.users (
  ...
  CONSTRAINT fk_users_students
    ...
    REFERENCES shp.students (reg_number)
    ON DELETE RESTRICT,
  CONSTRAINT fk_users_landlords
    FOREIGN KEY (related_id)
    REFERENCES shp.landlords (national_id_number)
    ON DELETE RESTRICT,
  CONSTRAINT fk_users_admin
    FOREIGN KEY (related_id)
    REFERENCES shp.students (reg_number) -- You can modify this part based on admin reference logic
    ON DELETE RESTRICT
) ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS shp.accommodations (
  ...
  CONSTRAINT fk_accommodations_landlords
...
CREATE TABLE IF NOT EXISTS shp.rooms (
  ...
  capacity INT NULL,
  accommodation_id INT NULL, -- Added foreign key reference to accommodations
  PRIMARY KEY (id),
  INDEX (accommodation_id ASC) ,
  CONSTRAINT fk_rooms_accommodations
    FOREIGN KEY (accommodation_id)
    REFERENCES shp.accommodations (id)
    ON DELETE RESTRICT
) ENGINE = InnoDB;
...
-- Table shp.payments
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS shp.payments (
  id INT NOT NULL AUTO_INCREMENT,
  payment_origin VARCHAR(45) NOT NULL,
  payment_destination VARCHAR(45) NOT NULL,
  time_of_payment DATETIME NULL,
  booking_id INT NULL, -- Added foreign key reference to bookings
  PRIMARY KEY (id),
  INDEX (booking_id ASC) ,
  CONSTRAINT fk_payments_bookings
    FOREIGN KEY (booking_id)
    REFERENCES shp.bookings (id)
    ON DELETE RESTRICT
) ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS shp.bookings (
  ...
  room_id INT NULL,
  PRIMARY KEY (id),
  FOREIGN KEY (room_id) REFERENCES shp.rooms (id) ON DELETE RESTRICT
) ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS shp.assignments (
  id INT NOT NULL AUTO_INCREMENT,
  booking_id INT NOT NULL, -- Added foreign key reference to bookings
  student_id VARCHAR(15) NOT NULL, -- Added foreign key reference to students
  room_id INT NOT NULL, -- Added foreign key reference to rooms
  assignment_date DATETIME NULL,
  PRIMARY KEY (id),
  INDEX (booking_id ASC) ,
  INDEX (student_id ASC) ,
  INDEX (room_id ASC) ,
  CONSTRAINT fk_assignments_bookings
    FOREIGN KEY (booking_id)
    REFERENCES shp.bookings (id)
    ON DELETE RESTRICT,
  CONSTRAINT fk_assignments_students
    FOREIGN KEY (student_id)
    REFERENCES shp.students (reg_number)
    ON DELETE RESTRICT,
  CONSTRAINT fk_assignments_rooms
    FOREIGN KEY (room_id)
    REFERENCES shp.rooms (id)
    ON DELETE RESTRICT
) ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS shp.queries (
  ...
  room_id INT NULL, -- Added foreign key reference to rooms
  creation_date DATETIME NULL,
  PRIMARY KEY (id),
  INDEX (sender_id ASC) ,
  INDEX (receiver_id ASC) ,
  INDEX (room_id ASC) ,
  CONSTRAINT fk_queries_students_sender
    FOREIGN KEY (sender_id)
    REFERENCES shp.students (reg_number)
    ON DELETE RESTRICT,
  CONSTRAINT fk_queries_landlords_sender
    FOREIGN KEY (sender_id)
    REFERENCES shp.landlords (national_id_number)
    ON DELETE RESTRICT,
  CONSTRAINT fk_queries_students_receiver
    FOREIGN KEY (receiver_id)
    REFERENCES shp.students (reg_number)
    ON DELETE RESTRICT,
  CONSTRAINT fk_queries_landlords_receiver
    FOREIGN KEY (receiver_id)
    REFERENCES shp.landlords (national_id_number)
    ON DELETE RESTRICT,
  CONSTRAINT fk_queries_rooms
    FOREIGN KEY (room_id)
    REFERENCES shp.rooms (id)
    ON DELETE RESTRICT
) ENGINE = InnoDB;
